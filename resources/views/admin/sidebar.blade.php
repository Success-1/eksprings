<nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
                <a class="nav-link" href="/show_products">
                  <span class="menu-icon">
                    <i class="mdi mdi-playlist-play"></i>
                  </span>
          ...
          <!-- <li class="nav-item ps-5 fs-3"> <a class="nav-link" href="/view_products">Add products</a></li>
          <li class="nav-item  ps-5 fs-3"> <a class="nav-link" href="/show_products">Show products</a></li> -->
          <!-- <li class="nav-item menu-items">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse show" id="ui-basic">
              ...
              <li class="nav-item  ps-5 fs-3"> <a class="nav-link" href="/show_products">Show products</a></li> -->
              <!-- <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/view_products">Add products</a></li>
